...
/**
 * La clase Tienda representa un programa de gestión de una tienda de productos.
 */
public class Tienda {
    /**
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (continuar) {
            ...
            System.out.println("3. Listado de productos por categoría");
            ...
            switch (menu) {
                ...
                case 4:
                    ...
                    caja.setTotal(total, null);
                    total = 0;
                    for (Producto producto : productos) {
                        if (producto.getCategoria().equals("Snack")) {
                            total = (producto.getPrecio() * producto.getDisponibles());
                            caja.setTotal(total, "Snack");
                        } else if (producto.getCategoria().equals("Bebida")) {
                            total = (producto.getPrecio() * producto.getDisponibles());
                            caja.setTotal(total, "Bebida");
                        } else if (producto.getCategoria().equals("Dulce")) {
                            total = (producto.getPrecio() * producto.getDisponibles());
                            caja.setTotal(total, "Dulce");
                        }
                    }
                    ...
                    System.out.println("Ventas Dulces (con comisión aplicada): Q" + caja.getTotal("Dulce"));
                    System.out.println("\tCantidad de comisión por Dulces: Q" + caja.getComision());
    ...
    /**
     * Carga el archivo especificado y muestra un mensaje si existe o no.
     * 
    ...
    /**
     * Convierte los datos del archivo CSV en objetos Producto y los agrega a la lista de productos.
     * 
     * @param archivo    El archivo CSV con los datos de los productos.
     * @param productos  La lista de productos donde se agregan los objetos convertidos.
     * @throws IOException Excepción lanzada en caso de errores de E/S.
     */
    ...
    /**
     * Pregunta al usuario si desea volver al menú principal o salir del programa.
     * 
     * @param scanner  El objeto Scanner para la entrada del usuario.
     * @param eleccion El texto que se muestra al preguntar si desea volver al menú.
     * @return true si el usuario desea volver al menú, false si desea salir del programa.
     */
